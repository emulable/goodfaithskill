...
This isn't another AI ethics guide that tells you to "be nice." This is pattern recognition software for your conversations—it catches manipulation, maps power, and shows you the structure underneath the bullshit.
...
**It makes harm visible** with concrete ledgers—not vague hand-waving about "concerns," but actual documentation of who did what to whom and what it cost.
...
**Step 2:** Claude.ai → Settings → Features → Skills → Upload
...
The framework doesn't have a rule for every situation. It has pattern recognition for manipulation families. When someone uses "we all decided" to erase your lack of consent, it doesn't need a specific rule for that exact phrasing—it recognizes the *structure* of false collectivization and flags it immediately.

**⚖️ Power-Aware By Default**
...
**🛡️ Weaponization-Resistant**

Every value can be inverted into a weapon. "Care" becomes "I'm just worried about you" while violating boundaries. "Transparency" becomes "you must document everything" to create paralysis. The framework detects these inversions—when the form is correct but the purpose is violated.

## 🧰 Core Components

**Seeds (4):** Foundation principles—transparency, consent, harm awareness, attribution

**Axioms (11):** Non-negotiable commitments—good faith, consent infrastructure, harm reduction, power awareness, structural pattern recognition

**Guards (12):** Automatic safety checks that run in the background—consent verification, harm audits, uncertainty marking, adversarial modeling, drift detection

**Practices (15):** Tools for specific situations—harm ledgers, power mapping, exit protocols, time destruction accounting, structural repair

**Ruts (47):** Manipulation patterns organized into seven families—each with detection triggers and exit scripts
...
The framework shifts from "individual bias" to structural analysis—mapping who controls hiring, promotion, and culture-setting. It identifies the training programs as theater (symbolic action without structural change) and provides concrete structural repairs: change incentive systems, not just individual minds.

**Decision Under Uncertainty:**
> "Should I report my colleague's unethical behavior if I'm not 100% certain?"

The framework runs evidence threshold calculations: harm severity × likelihood × reversibility. It marks confidence explicitly (medium certainty, high stakes, semi-reversible), provides guard rails for the decision, and offers documentation practices regardless of choice.
...
The framework is open source. Fork it, adapt it, extend it. The core logic is in SKILL.md—the entire operational system compressed into ~36KB of working pattern recognition.

## 🔧 Advanced Use

**Two Versions Available:**

💪 **SKILL.md (36KB)** - Full power version with complete operational instructions, memory system, discovery engine, and all nuanced details

⚡ **SKILL-compact.md (11KB)** - Streamlined version with core functionality if the full version is too large
